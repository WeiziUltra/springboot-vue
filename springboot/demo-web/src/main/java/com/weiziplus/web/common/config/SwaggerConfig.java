package com.weiziplus.web.common.config;
...
public class SwaggerConfig {
    ...
    private Docket apiDocument() {
        List<ResponseMessage> responseMessageList = new ArrayList<>(ToolUtils.initialCapacity(7));
    ...
    public Docket createPcRestApi() {
        return apiDocument()
                .groupName("web")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.weiziplus.web.core"))
                .paths(PathSelectors.any())
                .build();
    }
