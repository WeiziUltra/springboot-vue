package com.weiziplus.common.async;
...
public class UserAsync extends BaseService {
    ...
    public void updateAdminUserLastActiveTime(Integer userId, String ip) {
     ...
     */
    @Async("updateUserLastActiveTime")
    public void updateUserLastActiveTime(Long userId, String ip) {
        if (null == userId || 0 > userId) {
            return;
        }
        try {
